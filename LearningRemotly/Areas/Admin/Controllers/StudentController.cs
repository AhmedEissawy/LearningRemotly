...
namespace LearningRemotly.Areas.Admin.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PhoneNumber,Email,City")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PhoneNumber,Email,City")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
